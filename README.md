...
MCP stdio server wrapping `@ai-native-solutions/falladviser-us-sdk`.

## Install
```bash
claude mcp add falladviser-us -- npx -y @ai-native-solutions/falladviser-us-mcp
```
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=falladviser-us-mcp](https://sjgant80-hub.github.io/fallmarket/listing.html?id=falladviser-us-mcp)
...
- **Companion SDK** (`npm install @ai-native-solutions/falladviser-us-mcp-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add falladviser-us-mcp -- npx -y @ai-native-solutions/falladviser-us-mcp-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/falladviser-us-mcp-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=falladviser-us-mcp
- **Live URL**: https://sjgant80-hub.github.io/falladviser-us-mcp/
- **Source**: https://github.com/sjgant80-hub/falladviser-us-mcp
